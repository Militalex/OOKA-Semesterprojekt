...
@Service
public class CoolingMicroserviceService extends MicroserviceService {

    private static final Random RANDOM = new Random();

    public CoolingMicroserviceService() {
        super(Microservice.COOLING_MANAGEMENT_MICROSERVICE);
    }
