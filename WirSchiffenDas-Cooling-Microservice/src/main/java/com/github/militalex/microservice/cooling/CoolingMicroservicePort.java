package com.github.militalex.microservice.cooling;
...
@Service
public class CoolingMicroservicePort extends MicroservicePortWithCache {

    public CoolingMicroservicePort(CoolingMicroserviceService service,
        ...
        super(Microservice.COOLING_MANAGEMENT_MICROSERVICE, service, stateKafkaTemplate, resultToFrontendKafkaTemplate, resultToEngMngKafkaTemplate);
    }
}