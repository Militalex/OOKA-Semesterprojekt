...
import com.github.militalex.microservice.MicroservicePort;
...
@Service
public class EngineMngMicroservicePort extends MicroservicePort {
    ...
    public EngineMngMicroservicePort(EngineMngMicroserviceService service,
        ...
        super(Microservice.ENGINE_MANAGEMENT_MICROSERVICE, service, stateKafkaTemplate, resultToFrontendKafkaTemplate);
