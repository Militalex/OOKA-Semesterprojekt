...
@Service
public class StartMoniMicroserviceService extends MicroserviceService {

    private static final Random RANDOM = new Random();

    public StartMoniMicroserviceService() {
        super(Microservice.STARTING_MONITORING_MICROSERVICE);
    }
